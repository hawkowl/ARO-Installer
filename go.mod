...
require (
	...
	github.com/IBM/vpc-go-sdk v0.44.0 // indirect
	...
	github.com/openshift/cluster-api-provider-libvirt v0.2.1-0.20230203123120-e55e92c14b2c // indirect
	...
	github.com/openshift/machine-api-provider-ibmcloud v0.0.0-20230124105206-50aa171a52e1 // indirect
...
replace (
	...
	github.com/openshift/api => github.com/openshift/api v0.0.0-20230803134339-2d9b46419536
	...
	github.com/openshift/installer => github.com/hawkowl/installer-aro v0.0.0-20231219051730-b6af6300d6eb
	...
	sigs.k8s.io/cluster-api-provider-azure => github.com/openshift/cluster-api-provider-azure v0.1.0-alpha.3.0.20230619092109-8846366f4ae6
	sigs.k8s.io/cluster-api-provider-openstack => github.com/openshift/cluster-api-provider-openstack v0.0.0-20230329124526-7dc1669641fb
...
replace (
	...
	sigs.k8s.io/cluster-api => github.com/openshift/cluster-api v0.0.0-20230612092323-507f873307be
	sigs.k8s.io/cluster-api-provider-ibmcloud => github.com/openshift/cluster-api-provider-ibmcloud v0.0.0-20230504031246-d221afa4bee0
)

replace github.com/openshift/client-go => github.com/openshift/client-go v0.0.0-20230120202327-72f107311084

replace github.com/openshift/cluster-api-provider-libvirt => github.com/openshift/cluster-api-provider-libvirt v0.2.1-0.20230203123120-e55e92c14b2c

replace sigs.k8s.io/cluster-api-provider-aws/v2 => github.com/openshift/cluster-api-provider-aws/v2 v2.0.0-20230629082421-acb52a088682
